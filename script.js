...
var papers = [
    'https://firebasestorage.googleapis.com/v0/b/aniyouth-2dcbb.appspot.com/o/res%2F48316.webp?alt=media&token=f512260d-9775-4ac6-afbd-68c50e5e2851',
    'https://firebasestorage.googleapis.com/v0/b/aniyouth-2dcbb.appspot.com/o/res%2F34933.webp?alt=media&token=6097d8ea-77d0-41b7-978e-fa802b07d637',
    'https://firebasestorage.googleapis.com/v0/b/aniyouth-2dcbb.appspot.com/o/res%2F37349.webp?alt=media&token=f92168df-e478-4446-a027-2d043a930dfd',
    'https://firebasestorage.googleapis.com/v0/b/aniyouth-2dcbb.appspot.com/o/res%2F44511.webp?alt=media&token=72deb53a-8fcd-41b4-9fa4-fead7399d164',
    'https://firebasestorage.googleapis.com/v0/b/aniyouth-2dcbb.appspot.com/o/res%2F30276.webp?alt=media&token=2af8676c-feb1-43a0-af55-3e8b34bc85dd',
    'https://firebasestorage.googleapis.com/v0/b/aniyouth-2dcbb.appspot.com/o/res%2F30977.webp?alt=media&token=489903f9-95bb-45d9-98b5-670a7dd2e80f',
    'https://firebasestorage.googleapis.com/v0/b/aniyouth-2dcbb.appspot.com/o/res%2F51297.webp?alt=media&token=22df960c-168e-4811-a545-19560d85d1b8',
    'https://firebasestorage.googleapis.com/v0/b/aniyouth-2dcbb.appspot.com/o/res%2F15352.webp?alt=media&token=59ca8afa-cbf4-4baf-9411-3acd79642046',
    ...
    'https://anitype.fun/_next/image?url=https%3A%2F%2Fstorage.anitype.fun%2Ftrailers%2F11757%2Ftrailer.webp&w=3840&q=100',
    'https://anitype.fun/_next/image?url=https%3A%2F%2Fstorage.anitype.fun%2Ftrailers%2F50205%2Ftrailer.webp&w=3840&q=100'
];
...
if (paperSource === 'https://firebasestorage.googleapis.com/v0/b/aniyouth-2dcbb.appspot.com/o/res%2F48316.webp?alt=media&token=f512260d-9775-4ac6-afbd-68c50e5e2851') {
...
else if (paperSource === 'https://firebasestorage.googleapis.com/v0/b/aniyouth-2dcbb.appspot.com/o/res%2F34933.webp?alt=media&token=6097d8ea-77d0-41b7-978e-fa802b07d637') {
...
else if (paperSource === 'https://firebasestorage.googleapis.com/v0/b/aniyouth-2dcbb.appspot.com/o/res%2F37349.webp?alt=media&token=f92168df-e478-4446-a027-2d043a930dfd') {
...
else if (paperSource === 'https://firebasestorage.googleapis.com/v0/b/aniyouth-2dcbb.appspot.com/o/res%2F44511.webp?alt=media&token=72deb53a-8fcd-41b4-9fa4-fead7399d164') {
...
else if (paperSource === 'https://firebasestorage.googleapis.com/v0/b/aniyouth-2dcbb.appspot.com/o/res%2F30276.webp?alt=media&token=2af8676c-feb1-43a0-af55-3e8b34bc85dd') {
...
else if (paperSource === 'https://firebasestorage.googleapis.com/v0/b/aniyouth-2dcbb.appspot.com/o/res%2F30977.webp?alt=media&token=489903f9-95bb-45d9-98b5-670a7dd2e80f') {
...
else if (paperSource === 'https://firebasestorage.googleapis.com/v0/b/aniyouth-2dcbb.appspot.com/o/res%2F51297.webp?alt=media&token=22df960c-168e-4811-a545-19560d85d1b8') {
...
else if (paperSource === 'https://firebasestorage.googleapis.com/v0/b/aniyouth-2dcbb.appspot.com/o/res%2F15352.webp?alt=media&token=59ca8afa-cbf4-4baf-9411-3acd79642046') {
    ...
    video.src = "https://firebasestorage.googleapis.com/v0/b/aniyouth-2dcbb.appspot.com/o/res%2F15352.mp4?alt=media&token=b326683d-f724-4360-ab90-d640f257c860";
    video.load();
}
    ...
    play.addEventListener("click", function() {
        localStorage.setItem('tagAnime', "Токийский гуль");
        window.location.href = "anime/22391.html";
    })
}
...
else if (paperSource === 'https://anitype.fun/_next/image?url=https%3A%2F%2Fstorage.anitype.fun%2Ftrailers%2F11757%2Ftrailer.webp&w=3840&q=100') {
    title.textContent = "Мастера Меча Онлайн";
    caption.textContent = "И вот вышла многопользовательская игра нового поколения — игра, где смерть реальна и бегство невозможно. Единственный выход — дойти до конца. А называется игра «Sword Art Online». Не зная этой правды, десять тысяч игроков, используя нейрошлемы компании «Агис», зарегистрировались одновременно и тем самым положили начало смертельной битве, длящейся уже два долгих года.";
    video.src = "https://storage.anitype.fun/trailers/11757/trailer.webm";
    video.load();
}

else if (paperSource === 'https://anitype.fun/_next/image?url=https%3A%2F%2Fstorage.anitype.fun%2Ftrailers%2F50205%2Ftrailer.webp&w=3840&q=100') {
    title.textContent = "Аркнайтс: Прелюдия к рассвету";
    caption.textContent = "Стихийные бедствия неизвестного происхождения, называемые «катастрофами», хаотичным образом возникают на землях Терры. Чтобы спастись, большинство людей переселилось в кочевые города — огромные передвижные платформы. Ориджиниум — вещество, выглядящее как чёрный полупрозрачный кристаллический минерал, возникает в местах, где произошла катастрофа. Ориджиниум содержит в себе огромное количество энергии, что поспособствовало быстрому техническому прогрессу, но также он стал причиной возникновения неизлечимой болезни орипатии.";
    video.src = "https://storage.anitype.fun/trailers/50205/trailer.webm";
    video.load();
}
